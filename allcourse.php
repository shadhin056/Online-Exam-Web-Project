        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                    ...
                    while($r = mysqli_fetch_assoc($result))
                    {
                        ...
                        echo "<td><a style='color: #00CC66' href='addfile.php?id=$id'>Add to My Course</a>
<a style='color: #cb478d' href='removeAllow.php?id=$id'>Remove Course from my list</a>
</td>";
                        echo "<tr>";
                    }
                    ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                    ...
                    while($r1 = mysqli_fetch_assoc($result1))
                    {
                        ...
                        echo "<td><a style='color: #cb121e' href='addfile.php?id=$id'>Course remove</a>
</td>";
                        echo "<tr>";
                    }
                    ?>
